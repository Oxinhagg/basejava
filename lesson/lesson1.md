...
- Реализуйте класс `com.oxinhagg.webapp.storage.ArrayStorage`, организовав хранение резюме на основе массива с методами `save, get, delete, size, clear, getAll`
...
```
- Протестируйте вашу реализацию с помощью классов `com.oxinhagg.webapp.MainArray.main()` и `com.oxinhagg.webapp.MainTestArrayStorage.main()`
...
6. `com.oxinhagg.webapp.model.Resume r` — давай переменным осмысленные имена, например `resume`. `r` допустимо в коротких циклах и лямбдах.
...
1. Не меняйте сигнатуры методов в `com.oxinhagg.webapp.storage.ArrayStorage`
